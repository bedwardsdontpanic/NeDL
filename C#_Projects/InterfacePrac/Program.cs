...
class helloworld {
    ...
    static List<Employee> updateEmployee(List<Employee> theEmployees) {
        ...
        if(newEmployeeType == "hourly"){
            newEmp = new HourlyEmployee(newEmployeeWage, newEmployeeFirstName, newEmployeeLastName, newEmployeeType);
        }
        else{
            newEmp = new SalaryEmployee(newEmployeeWage, newEmployeeFirstName, newEmployeeLastName, newEmployeeType);
        }
